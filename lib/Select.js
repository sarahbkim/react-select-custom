...
var Select = React.createClass({
	...
	propTypes: {
		...
		customSelectValue: React.PropTypes.func,
    customPopValue: React.PropTypes.func,
    customRemoveValue: React.PropTypes.func
	},
   ...
   */
	...
	componentWillMount: function componentWillMount() {
		var _this = this;
    this.lazyAsyncOptions = _.debounce(this.loadAsyncOptions, 500);
		this._optionsCache = {};
	...
	handleInputChange: function handleInputChange(event) {
      ...
      this.lazyAsyncOptions(event.target.value, {
				isLoading: false,
				isOpen: true
			}, this._bindCloseMenuIfClickedOutside);
		} else {
	...
	loadAsyncOptions: function loadAsyncOptions(input, state, callback) {
		...
		this.props.asyncOptions(input, function (err, data) {
			...
			var newState = {
				...
				focusedOption: _this6._getNewFocusedOption(data.options)
			};
			for (var key in state) {
				if (state.hasOwnProperty(key)) {
					newState[key] = state[key];
	...
	render: function render() {
		...
		if (this.props.multi) {
			this.state.values.forEach(function (val) {
				...
				var valueComponent = React.createElement(this.props.valueComponent, {
					key: val.suggestionId || val.value,
					option: val,
		...
		var clear = this.props.clearable && this.state.value && !this.props.disabled ? React.createElement('span', { className: 'Select-clear', title: this.props.multi ? this.props.clearAllText : this.props.clearValueText, 'aria-label': this.props.multi ? this.props.clearAllText : this.props.clearValueText, onMouseDown: this.props.customClearValue ? this.props.customClearValue : this.clearValue, onClick: this.props.customClearValue ? this.props.customClearValue : this.clearValue, dangerouslySetInnerHTML: { __html: '&times;' } }) : null;
